...
def evaluate(args):
    ...
    metrics_path = output_dir / "stage2_frozen_resnet50_similarity_metrics.json"
    predictions_path = output_dir / "stage2_frozen_resnet50_similarity_predictions.csv"
...
def parse_args():
    ...
    parser.add_argument("--feature-path", default="features/resnet50_prototypes.pt")
